...
if __name__ == '__main__':
   ...
   # print(v)
    ...
    step_list4 = [
        {'测试用例编号': 'api_case_02', '测试用例名称': '测试能否创建标签接口测试', '用例执行': '是', '用例步骤': 'step01', '接口名称': '获取access_token接口', '请求方式': 'get', '请求头部信息': '', '请求地址': '/cgi-bin/token', '请求参数(get)': '{"grant_type":"client_credential","appid":"wxf26ad2ae7497289a","secret":"177931a321a1f39a47a1ef202d8a3497"}', '请求参数(post)': '', '取值方式': '正则取值', '取值代码': '$access_token', '取值变两': 'token'},
        {'测试用例编号': 'api_case_02', '测试用例名称': '测试能否创建标签接口测试', '用例执行': '是', '用例步骤': 'step02', '接口名称': '创建标签接口', '请求方式': 'post', '请求头部信息': '', '请求地址': 'cgi-bin/tags/create', '请求参数(get)': '{"access_token":"40_86J6fB6om3uNj_S-EqISPwK4pR_n9FeE48KvOkLWf4DtcD2JA8hqfEbrb3nwy-XfFHD8JtA3s6zqtzfnHfq6QWwc1k99yPthnNkqQ2wDa-riYVKXBdVHdZOfmsIeGxsXkcyzTTs5bvb-D0E8WVWbADAHGH"}', '请求参数(post)': '{   "tag" : {     "name" : "aa"   } } ', '取值方式': '正则取值', '取值代码': '', '取值变两': ''}]
    requestsUtils =RequestsUtils()
